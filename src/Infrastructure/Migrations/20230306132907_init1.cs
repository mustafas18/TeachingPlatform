    ...
    public partial class init1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "IELTS Speaking", "IELTS Speaking", "IELTS Speaking" },
                    { 2, "IELTS Writing", "IELTS Writing", "IELTS Writing" }
                });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "FullNameEn", "FullNameFa", "UserName" },
                values: new object[] { 1, "Zahra Bazghandi", "زهرا بازقندی", "zahra_bazghandi" });
