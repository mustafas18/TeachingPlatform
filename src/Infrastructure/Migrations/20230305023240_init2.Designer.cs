...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230305023240_init2")]
    partial class init2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.CourseAggregate.Section", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.CourseAggregate.Course", b =>
                {
                    ...
                    b.OwnsOne("Core.Entities.CourseAggregate.CourseCategory", "Category", b1 =>
                        {
            ...
            modelBuilder.Entity("Core.Entities.CourseAggregate.Session", b =>
                {
                    b.HasOne("Core.Entities.CourseAggregate.Section", "Section")
                        .WithMany("Sessions")
