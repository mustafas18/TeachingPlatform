        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mobile = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PayId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConsultantSchedules_Teachers_ConsultantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<int>(type: "int", nullable: false),
                    RequestGuid = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeacherRequests_Lessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "NameEn", "NameFa" },
                values: new object[] { 1, "IELTS", "IELTS" });

            migrationBuilder.InsertData(
                table: "Lessons",
                columns: new[] { "Id", "Description", "NameEn", "NameFa" },
                values: new object[,]
                {
                    { 1, "IELTS", "IELTS", "IELTS" },
                    { 2, "IELTS Writing", "IELTS Writing", "IELTS Writing" }
                });

            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "Email", "FullNameEn", "FullNameFa", "Mobile", "Reputation", "UserName" },
                values: new object[] { 1, "bazghandizahra@gmail.com", "Zahra Bazghandi", "زهرا بازقندی", "09155727952", 10, "zahra_bazghandi" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherRequests_LessonId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherRequests_TeacherId",
                table: "TeacherRequests",
                column: "TeacherId");
        }
