...
{
    /// <inheritdoc />
    public partial class teaching : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "Email", "FullNameEn", "FullNameFa", "Mobile", "UserName" },
                values: new object[] { 1, "bazghandizahra@gmail.com", "Zahra Bazghandi", "زهرا بازقندی", "09155727952", "zahra_bazghandi" });
